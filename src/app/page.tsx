...
import { TankProvider } from "@/services/TankContext";
      ...
      <div className="lg:max-w-7xl flex flex-col justify-between mx-auto min-h-screen gap-16 py-10 font-[family-name:var(--font-geist-sans)] border border-black">
        ...
        <footer className="row-start-3 flex flex-col gap-6 flex-wrap items-center justify-center text-sm px-5">
          <div className="lg:w-3/4 text-center italic">
            ...
            information, we are not perfect. All information provided here
            should be a starting point in research, not an infallible source of
            truth. As a hobbyist, it’s important to review information from
            multiple sources and get feedback from the community before making
            final decisions about stocking. Want to give us some feedback? Email
            us!
          </div>
